...
const users = [
  {
    username: 'arnold@hotmail.com',
    nickname: 'Arnold',
    role: 'ADMIN',
    password: '$2b$10$cp1wgssiSadKppGqQEowUuxzqlcHmEFdZLRRurWZTwwbW6VZwjA.a',
  },
  {
    username: 'arthur@hotmail.com',
    nickname: 'Arthur',
    role: 'ADMIN',
    password: '$2b$10$cp1wgssiSadKppGqQEowUuxzqlcHmEFdZLRRurWZTwwbW6VZwjA.a',
  },
...
Users.create(users, (err) => {
  if (err) { throw (err); }
  console.log(`Created ${users.length} events`);
